...
import com.yoke.ego.common.pojo.ItemDesc;
import com.yoke.ego.common.pojo.ItemDescExample;
...
public interface ItemDescMapper {
    ...
    int deleteByPrimaryKey(Long itemDescId);
    ...
    ItemDesc selectByPrimaryKey(Long itemDescId);
